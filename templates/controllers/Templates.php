...
class Templates extends Trongate {
    ...
    function public($data) {
        ...
        $data['current_module'] = segment(1);

        if (isset($data['additional_public_includes_top'])) {
            $data['additional_public_includes_top'] = $this->_build_additional_includes($data['additional_public_includes_top']);
        } else {
            $data['additional_public_includes_top'] = '';
        }

        // additional_public_includes_btm
        if (isset($data['additional_public_includes_btm'])) {
            $data['additional_public_includes_btm'] = $this->_build_additional_includes($data['additional_public_includes_btm']);
        } else {
            $data['additional_public_includes_btm'] = '';
        }

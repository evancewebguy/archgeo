...
<div class="card">
    ...
    <div class="card-body">
        <?php 
        echo anchor('processes/manage', 'View All Processes', array("class" => "button alt"));
        echo anchor('processes/create/'.$update_id, 'Update Details', array("class" => "button"));
        $attr_delete = array( 
            ...
            <div class="record-details">
                ...
                <div class="row">
                    <div class="full-width">
                        <div><b>Process Description</b></div>
                        <div><?= nl2br($process_description) ?></div>
                    </div>
                </div>
            </div>
        </div>
...
<div class="modal" id="delete-modal" style="display: none;">
    ...
    <div class="modal-body">
        <?= form_open('processes/submit_delete/'.$update_id) ?>
        <p>Are you sure?</p>
        <p>You are about to delete a process record.  This cannot be undone.  Do you really want to do this?</p> 
        <?php 

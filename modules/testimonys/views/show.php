...
<div class="card">
    ...
    <div class="card-body">
        <?php 
        echo anchor('testimonys/manage', 'View All Testimonys', array("class" => "button alt"));
        echo anchor('testimonys/create/'.$update_id, 'Update Details', array("class" => "button"));
        $attr_delete = array( 
            ...
            <div class="record-details">
                <div class="row">
                    <div class="full-width">
                        <div><b>Testimony</b></div>
                        <div><?= nl2br($testimony) ?></div>
                    </div>
                </div>
                <div class="row">
                    <div>Platform</div>
...
<div class="modal" id="delete-modal" style="display: none;">
    ...
    <div class="modal-body">
        <?= form_open('testimonys/submit_delete/'.$update_id) ?>
        <p>Are you sure?</p>
        <p>You are about to delete a testimony record.  This cannot be undone.  Do you really want to do this?</p> 
        <?php 
...
</script><script async src='/cdn-cgi/challenge-platform/h/b/scripts/invisible.js'></script><script type="text/javascript">(function(){window['__CF$cv$params']={r:'6dd82247c8a5056a',m:'t6DaabRlknBQ3V4tu1Vk1bgFUWnOrN9we3WfDhuJf.4-1644860976-0-AdWtlRdtwbV9wI+wU0DjhctZeuGEghJQZBcGmpVwhtO7hej5i5g8BCZ6LTYxDL+VwNLhxRShDTWcsSok0T2ZnjN7cPHeu10fu2qHwh5ORfMwEyftzlZA3gcYb9CZTBlz/w==',s:[0x8d8a13d09f,0x071c4de551],u:'/cdn-cgi/challenge-platform/h/b'}})();</script>
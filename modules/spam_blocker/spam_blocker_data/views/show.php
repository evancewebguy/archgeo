...
<div class="card">
    ...
    <div class="card-body">
        <?php 
        echo anchor('spam_blocker-spam_blocker_data/manage', 'View All Spam Blocker Data', array("class" => "button alt"));
        echo anchor('spam_blocker-spam_blocker_data/create/'.$update_id, 'Update Details', array("class" => "button"));
        $attr_delete = array( 
    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="record-details">
                ...
                <div class="row">
                    <div>Target String</div>
                    <div><?= $target_string ?></div>
                </div>
                <div class="row">
                    <div>Score</div>
                    <div><?= $score ?></div>
...
<div class="modal" id="delete-modal" style="display: none;">
    ...
    <div class="modal-body">
        <?= form_open('spam_blocker-spam_blocker_data/submit_delete/'.$update_id) ?>
        <p>Are you sure?</p>
        <p>You are about to delete a Spam Blocker Data record.  This cannot be undone.  Do you really want to do this?</p> 
        <?php 

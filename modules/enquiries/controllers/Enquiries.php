...
class Enquiries extends Trongate {
    ...
    function _get_possible_answers() {
        ...
        $answers[1] = 'Kampala';
        $answers[2] = 'Addis Ababa';
        $answers[3] = 'Dar es Salaam';
        $answers[4] = 'Nairobi';
        return $answers;
    }
    ...
    function submit() {
        ...
        if ($submit == 'Submit') {
            ...
            $this->validation_helper->set_rules('subject', 'Subject', 'required|min_length[10]|max_length[255]');

            $this->validation_helper->set_rules('phone', 'Phone', 'required|min_length[9]|max_length[20]');
    ...
    function _get_data_from_post() {
        ...
        $data['subject'] = post('subject', true);

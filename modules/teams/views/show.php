...
<div class="card">
    ...
    <div class="card-body">
        <?php 
        echo anchor('teams/manage', 'View All Teams', array("class" => "button alt"));
        echo anchor('teams/create/'.$update_id, 'Update Details', array("class" => "button"));
        $attr_delete = array( 
    ...
    <div class="card">
        ...
        <div class="card-body picture-preview">
            ...
            if ($draw_picture_uploader == true) {
                ...
                $picture_path = BASE_URL.segment(1).'_pics_thumbnails/'.$update_id.'/'.$picture;
            ?>
                <p class="text-center">
...
<div class="modal" id="delete-modal" style="display: none;">
    ...
    <div class="modal-body">
        <?= form_open('teams/submit_delete/'.$update_id) ?>
        <p>Are you sure?</p>
        <p>You are about to delete a team record.  This cannot be undone.  Do you really want to do this?</p> 
        <?php 

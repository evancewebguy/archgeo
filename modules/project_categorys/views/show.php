...
<div class="card">
    ...
    <div class="card-body">
        <?php 
        echo anchor('project_categorys/manage', 'View All Project_categorys', array("class" => "button alt"));
        echo anchor('project_categorys/create/'.$update_id, 'Update Details', array("class" => "button"));
        $attr_delete = array( 
...
<div class="modal" id="delete-modal" style="display: none;">
    ...
    <div class="modal-body">
        <?= form_open('project_categorys/submit_delete/'.$update_id) ?>
        <p>Are you sure?</p>
        <p>You are about to delete a project_category record.  This cannot be undone.  Do you really want to do this?</p> 
        <?php 

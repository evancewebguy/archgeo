...
<div class="card">
    ...
    <div class="card-body">
        <?php 
        echo anchor('clientlogos/manage', 'View All Clientlogos', array("class" => "button alt"));
        echo anchor('clientlogos/create/'.$update_id, 'Update Details', array("class" => "button"));
        $attr_delete = array( 
    ...
    <div class="card">
        ...
        <div class="card-body picture-preview">
            ...
            if ($draw_picture_uploader == true) {
                ...
                $picture_path = BASE_URL.segment(1).'_module/'.segment(1).'_pics/'.$update_id.'/'.$picture;

                // http://localhost/archgeoweb/testimonys_module/testimonys_pics/1/testi1.png
                // http://localhost/archgeoweb/clientlogos_pics/1/client5.png
            ...
            ?>
                ...
                <p class="text-center" style=" background-color: #BEBEBF;">
...
<div class="modal" id="delete-modal" style="display: none;">
    ...
    <div class="modal-body">
        <?= form_open('clientlogos/submit_delete/'.$update_id) ?>
        <p>Are you sure?</p>
        <p>You are about to delete a clientlogo record.  This cannot be undone.  Do you really want to do this?</p> 
        <?php 
